...
//agregarLibro(13, "hola", "yo", 1986, "terror");
...
function buscarLibro(criterio, valor){
    ...
    let buscados = [];
    //le doy formato al valor ingresado
...
//buscarLibro("genero", "terror");
//buscarLibro("autor"", "ray bradbury");
...
function registrarUsuario(nombre, email){
    let nuevoUsuario = {id: usuarios.length+1, nombre: nombre ,email: email, librosPrestados: []};
    usuarios.push(nuevoUsuario);
    //console.log(usuarios);
    return nuevoUsuario;
};

//registrarUsuario("Martin Salomone", "msalo@gmail.com");
...
//buscarUsuario("msuvia@gmail.com");
//buscarUsuario("mia@gmail.com");
...
function borrarUsuario(nombre, email){
    ...
    for (let i=0; i<usuarios.length; i++) {
        ...
        if (usuarios[i].email === emailFormato) {
            ...
            if (usuarios[i].nombre === nombreFormato){
                ...
                //el nombre de usuario ingresado no coinceide con el nombre del usuario registrado con ese email
    ...
    //no encontró el mail en el array
    console.log("El usuario ingresado no se encuentra registrado en el sistema.");
    return;
};

//borrarUsuario("CARLA SILVA", "carlita67@gmail.com");
//borrarUsuario("yo", "carlita67@gmail.com");
//borrarUsuario("uih", "jhvn ");



// 4. Sistema de Préstamos
// a) Desarrollar una función prestarLibro(idLibro, idUsuario) que marque un libro como no disponible 
//y lo agregue a la lista de libros prestados del usuario.
...
//✓ Cantidad total de libros. si
//✓ Cantidad de libros prestados. si
...
//a) Implementar una función librosConPalabrasEnTitulo() que identifique y muestre todos los 
//libros cuyo título contiene más de una palabra (no títulos que contengan números ni otros caracteres).
...
//libros.push({id: 44, titulo: "John", autor: "papa noel", anio:1998, genero: "novela", disponible: true});
//agregarLibro(89, "la hojaraSca", "maNOLo", 1986, "terror");
//normalizarDatos();
//console.log(libros);
//console.log(usuarios);
